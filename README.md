...
This package doen't use goroutine for running api requests because I just learned Go in general. I would probably update this package in the future once I learned deep into it.
